...
const ATOM_FEED_URL = 'https://github.com/prosfus/orca/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/prosfus/orca/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/prosfus\/orca\/releases\/tag\/([^"]+)"/g
